...
var correct_answers = ["Olive", "Oak", "Orange"]
...
func _on_owl_1_pressed() -> void:
	check_answer("Duck", $TextureRect/Owl1)


func _on_owl_2_pressed() -> void:
	check_answer("Olive", $TextureRect/Owl2)


func _on_owl_3_pressed() -> void:
	check_answer("Oak", $TextureRect/Owl3)


func _on_owl_4_pressed() -> void:
	check_answer("Orange", $TextureRect/Owl4)


func _on_owl_5_pressed() -> void:
	check_answer("Jar", $TextureRect/Owl5)
