...
var question_data = [
	{
		...
		"all_choices": ["Orange", "Owl", "Octopus", "Car", "Apple"]
	},
	{
		"correct_answers": ["Ocean", "Onion", "Ostrich"],
		"all_choices": ["Ocean", "Banana", "Onion", "Ostrich", "Tree"]
	}
]
...
func _on_owl_2_pressed() -> void:
	check_answer(all_choices[1], $TextureRect/Owl2)

func _on_owl_3_pressed() -> void:
	check_answer(all_choices[2], $TextureRect/Owl3)

func _on_owl_4_pressed() -> void:
	check_answer(all_choices[3], $TextureRect/Owl4)
