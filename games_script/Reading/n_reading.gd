...
func is_correct_match(item_name: String, zone_name: String) -> bool:
	...
	if "student" in clean_item and "studentdrop" in clean_zone:
		return true
	elif "holding" in clean_item and "holdingdrop" in clean_zone:
		return true
	elif "notebook" in clean_item and "notebookdrop" in clean_zone:
		return true
