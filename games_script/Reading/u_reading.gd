...
func _ready() -> void:
	feedback_label.text = "🔍The one you wears at School"
	start_timer()
...
func check_answer(choice: String, node: Control) -> void:
	...
	if choice == correct_answer:
		timer_active = false
		feedback_label.text = "✅ Correct! Uniform is the one you wears at School"
...
func _on_house_pressed() -> void:
	check_answer("House", $House)



func _on_out_pressed() -> void:
	check_answer("Out", $Out)


func _on_uniform_pressed() -> void:
	check_answer("Uniform", $Uniform)
