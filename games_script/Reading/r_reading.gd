...
# ✅ GAME CONFIGURATION — 2 QUESTION SETS FOR LETTER R
var question_data = [
	{
		"correct_answers": ["Rocket", "Round", "Race"],
		"all_choices": ["Rocket", "Round", "Race", "Violin", "Books"]
	},
	{
		"correct_answers": ["Rainbow", "Rabbit", "Ring"],
		"all_choices": ["Rainbow", "Rabbit", "Ring", "Apple", "Table"]
	}
]
...
func game_over(success: bool):
	...
	if has_node("TextureRect/Rabbit1"): $TextureRect/Rabbit1.visible = false
	if has_node("TextureRect/Rabbit2"): $TextureRect/Rabbit2.visible = false
	if has_node("TextureRect/Rabbit3"): $TextureRect/Rabbit3.visible = false
	if has_node("TextureRect/Rabbit4"): $TextureRect/Rabbit4.visible = false
	if has_node("TextureRect/Rabbit5"): $TextureRect/Rabbit5.visible = false
...
func _on_rabbit_1_pressed() -> void:
	check_answer(all_choices[0], $TextureRect/Rabbit1)

func _on_rabbit_2_pressed() -> void:
	check_answer(all_choices[1], $TextureRect/Rabbit2)

func _on_rabbit_3_pressed() -> void:
	check_answer(all_choices[2], $TextureRect/Rabbit3)

func _on_rabbit_4_pressed() -> void:
	check_answer(all_choices[3], $TextureRect/Rabbit4)

func _on_rabbit_5_pressed() -> void:
	check_answer(all_choices[4], $TextureRect/Rabbit5)
...
func restart_game() -> void:
	...
	if has_node("TextureRect/Rabbit1"): $TextureRect/Rabbit1.visible = true
	if has_node("TextureRect/Rabbit2"): $TextureRect/Rabbit2.visible = true
	if has_node("TextureRect/Rabbit3"): $TextureRect/Rabbit3.visible = true
	if has_node("TextureRect/Rabbit4"): $TextureRect/Rabbit4.visible = true
	if has_node("TextureRect/Rabbit5"): $TextureRect/Rabbit5.visible = true
