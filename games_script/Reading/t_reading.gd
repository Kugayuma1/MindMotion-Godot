...
var choices = [
	{"name": "Toothbrush", "texture": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/25.png"},
	{"name": "Shampoo", "texture": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/27.png"},
	{"name": "Soap", "texture": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/26.png"}
]

# Game configuration
var correct_answer := "Toothbrush"
var clue := "🔍 The one that cleans your Teeth"
var clue_short := "Cleans your teeth?"
var success_message := "✅ Correct! Toothbrush to clean your teeth"
...
func _on_toothbrush_pressed() -> void:
	check_answer(button_to_choice[$Toothbrush], $Toothbrush)

func _on_shampoo_pressed() -> void:
	check_answer(button_to_choice[$Shampoo], $Shampoo)

func _on_soap_pressed() -> void:
	check_answer(button_to_choice[$Soap], $Soap)
