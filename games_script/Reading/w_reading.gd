...
var word_data = [
	{"word": "WHALE", "image_path": "res://Game Assets/Reading Assets/Assetsulit/50.png", "available_letters": ["W", "E", "U", "Q", "L", "A", "H", "E"]},
	{"word": "WATCH", "image_path": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/Watch.png", "available_letters": ["Z", "C", "A", "T", "L", "A", "H", "W"]},
]
