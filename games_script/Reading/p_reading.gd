...
var word_data = [
	{"word": "PIANO", "image_path": "res://Game Assets/Reading Assets/Assetsulit/42.png", "available_letters": ["L", "A", "O", "Y", "P", "N", "I", "M"]},
	{"word": "PIZZA", "image_path": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/Pizza.png", "available_letters": ["A", "I", "Z", "K", "P", "M", "K", "Z"]},
]
