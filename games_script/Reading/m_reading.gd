...
var choices = [
	{"name": "Monkey", "texture": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/28.png"},
	{"name": "Lizard", "texture": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/29.png"},
	{"name": "Zebra", "texture": "res://Game Assets/Reading Assets/Assetsulit/2NANAMAN/30.png"}
]

# Game configuration
var correct_answer := "Monkey"
var clue := "🔍 The one who likes banana!"
var clue_short := "Likes banana?"
var success_message := "✅ Correct! Monkey is the one who likes banana"
...
func _on_monkey_pressed() -> void:
	check_answer(button_to_choice[$Monkey], $Monkey)

func _on_lizard_pressed() -> void:
	check_answer(button_to_choice[$Lizard], $Lizard)

func _on_zebra_pressed() -> void:
	check_answer(button_to_choice[$Zebra], $Zebra)
