...
var correct_answers = ["Flower", "Frog", "Fog"]
...
func _on_fish_1_pressed() -> void:
	check_answer("Flower", $TextureRect/Fish1)


func _on_fish_2_pressed() -> void:
	check_answer("Kite", $TextureRect/Fish2)


func _on_fish_3_pressed() -> void:
	check_answer("Zebra", $TextureRect/Fish3)


func _on_fish_4_pressed() -> void:
	check_answer("Frog", $TextureRect/Fish4)


func _on_fish_5_pressed() -> void:
	check_answer("Fog", $TextureRect/Fish5)
