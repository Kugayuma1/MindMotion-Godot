...
func game_over(success: bool):
	...
	if has_node("TextureRect/Fish1"): $TextureRect/Fish1.visible = false
	if has_node("TextureRect/Fish2"): $TextureRect/Fish2.visible = false
	if has_node("TextureRect/Fish3"): $TextureRect/Fish3.visible = false
	if has_node("TextureRect/Fish4"): $TextureRect/Fish4.visible = false
	if has_node("TextureRect/Fish5"): $TextureRect/Fish5.visible = false
...
func restart_game() -> void:
	...
	if has_node("TextureRect/Fish1"): $TextureRect/Fish1.visible = true
	if has_node("TextureRect/Fish2"): $TextureRect/Fish2.visible = true
	if has_node("TextureRect/Fish3"): $TextureRect/Fish3.visible = true
	if has_node("TextureRect/Fish4"): $TextureRect/Fish4.visible = true
	if has_node("TextureRect/Fish5"): $TextureRect/Fish5.visible = true
