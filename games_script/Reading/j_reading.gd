...
var correct_answers = ["Jaguar", "Jug", "Junk"]
...
func _on_jeep_1_pressed() -> void:
	check_answer("Jaguar", $TextureRect/Jeep1)


func _on_jeep_2_pressed() -> void:
	check_answer("Jug", $TextureRect/Jeep2)


func _on_jeep_3_pressed() -> void:
	check_answer("Draw", $TextureRect/Jeep3)


func _on_jeep_4_pressed() -> void:
	check_answer("Glass", $TextureRect/Jeep4)


func _on_jeep_5_pressed() -> void:
	check_answer("Junk", $TextureRect/Jeep5)
