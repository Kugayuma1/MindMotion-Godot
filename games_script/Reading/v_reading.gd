...
func game_over(success: bool):
	...
	if has_node("TextureRect/Volc1"): $TextureRect/Volc1.visible = false
	if has_node("TextureRect/Volc2"): $TextureRect/Volc2.visible = false
	if has_node("TextureRect/Volc3"): $TextureRect/Volc3.visible = false
	if has_node("TextureRect/Volc4"): $TextureRect/Volc4.visible = false
	if has_node("TextureRect/Volc5"): $TextureRect/Volc5.visible = false
...
func restart_game() -> void:
	...
	if has_node("TextureRect/Volc1"): $TextureRect/Volc1.visible = true
	if has_node("TextureRect/Volc2"): $TextureRect/Volc2.visible = true
	if has_node("TextureRect/Volc3"): $TextureRect/Volc3.visible = true
	if has_node("TextureRect/Volc4"): $TextureRect/Volc4.visible = true
	if has_node("TextureRect/Volc5"): $TextureRect/Volc5.visible = true
