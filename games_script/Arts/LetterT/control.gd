# T_Arts Control Script with Popup System
extends Control
...
func _ready():
	...
	# Debug info
	print("T_Arts Game Manager Ready!")
...
func game_over(success: bool):
	print("T_Arts game over called with success: ", success)
	...
	if popup_instance:
		...
		print("T_Arts popup instantiated and added to scene")
...
func force_win_check():
	print("🔍 FORCING T_ARTS WIN CHECK...")
	check_win_condition()
