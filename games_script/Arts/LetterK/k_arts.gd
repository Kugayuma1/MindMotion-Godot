# K_Arts Control Script with Popup System
extends Control
...
func _ready():
	...
	print("K_Arts Game Manager Ready!")
...
func game_over(success: bool):
	print("K_Arts game over called with success: ", success)
	hide_game_elements()
	if success:
		if countdown >= 10:
	...
	if popup_instance:
		...
		print("K_Arts popup instantiated and added to scene")
...
func force_win_check():
	print("🔍 FORCING K_ARTS WIN CHECK...")
	check_win_condition()
