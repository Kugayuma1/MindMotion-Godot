# I_Arts Control Script with Popup System
extends Control
...
func _ready():
	...
	# Debug info
	print("I_Arts Game Manager Ready!")
...
func game_over(success: bool):
	print("I_Arts game over called with success: ", success)
	...
	if popup_instance:
		...
		print("I_Arts popup instantiated and added to scene")
...
func force_win_check():
	print("🔍 FORCING I_ARTS WIN CHECK...")
	check_win_condition()
