# C_Arts Control Script with Popup System
extends Control
...
func _ready():
	...
	# Debug info
	print("C_Arts Game Manager Ready!")
...
func game_over(success: bool):
	print("C_Arts game over called with success: ", success)
	...
	if popup_instance:
		...
		print("C_Arts popup instantiated and added to scene")
...
func force_win_check():
	print("🔍 FORCING C_ARTS WIN CHECK...")
	check_win_condition()
