# W_Arts Control Script with Popup System
extends Control
...
func _ready():
	...
	# Debug info
	print("W_Arts Game Manager Ready!")
...
func game_over(success: bool):
	print("W_Arts game over called with success: ", success)
	...
	if popup_instance:
		...
		print("W_Arts popup instantiated and added to scene")
...
func force_win_check():
	print("🔍 FORCING W_ARTS WIN CHECK...")
	check_win_condition()
