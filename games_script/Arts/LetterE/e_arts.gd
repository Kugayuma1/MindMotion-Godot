...
func update_timer() -> void:
	...
	if countdown <= 0:
		...
		ProgressManager.save_progress("eart", false)
		Global.refresh_everything_after_stage_completion("eart", false)
...
func win_game():
	...
	ProgressManager.save_progress("eart", true)
	Global.refresh_everything_after_stage_completion("eart", true)
